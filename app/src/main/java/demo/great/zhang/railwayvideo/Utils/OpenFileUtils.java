...
public class OpenFileUtils {
    ...
    public static void commonOpenFileWithType(Context mContext, File file, String type) {
        ...
        FileProvider7.setIntentDataAndType(mContext, intent, type, file, true);
    ...
    public static void openVideoFileIntent(Context mContext, File file) {
        ...
        FileProvider7.setIntentDataAndType(mContext, intent, DATA_TYPE_VIDEO, file, false);
        mContext.startActivity(intent);
    }
    ...
    private static void openAudioFileIntent(Context mContext, File file) {
        ...
        intent.putExtra("oneshot", 0);
        intent.putExtra("configchange", 0);
        FileProvider7.setIntentDataAndType(mContext, intent, DATA_TYPE_AUDIO, file, false);
        mContext.startActivity(intent);
    }
}